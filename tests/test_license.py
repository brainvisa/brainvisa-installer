...
def test_license_License():
	...
	os.path.isfile('out/brainvisa.app.licenses.mylicense/meta/License_CeCILL_V2.1_en_EN.txt')
	x = XmlFile()
	...
	assert x.root.find('Licenses')[0].attrib['file'] == 'License_CeCILL_V2.1_en_EN.txt'
