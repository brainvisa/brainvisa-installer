...
def test_utils_IFWConfig():
	x = IFWConfig(
		...
		TagRepositories = (
			TagRepository('http://localhost/repositories/linux-x86-64/', '1'),
			TagRepository('http://localhost/repositories/linux-x86-32/', '0'),
	...
	assert x.root_subelement('RunProgramArguments').text == 'RunProgramArguments 0x32'
	assert x.root_subelement('RunProgramDescription').text == 'RunProgramDescription 0x99'
	...
	assert x.root_subelement('RemoteRepositories')[0][0].text == 'http://localhost/repositories/linux-x86-64/'
	assert x.root_subelement('RemoteRepositories')[0][1].text == '1'
	assert x.root_subelement('RemoteRepositories')[1][0].text == 'http://localhost/repositories/linux-x86-32/'
	assert x.root_subelement('RemoteRepositories')[1][1].text == '0'
	assert x.root_subelement('RemoteRepositories')[2][0].text == 'http://localhost/repositories/win32/'
	assert x.root_subelement('RemoteRepositories')[2][1].text == '0'
	assert x.root_subelement('RemoteRepositories')[3][0].text == 'http://localhost/repositories/osx/'
	assert x.root_subelement('RemoteRepositories')[3][1].text == '0'
	assert x.root_subelement('RemoteRepositories')[4][0].text == 'http://localhost/repositories/test/'
	...
	assert x.root_subelement('DependsOnLocalInstallerBinary').text == 'DependsOnLocalInstallerBinary 0x87'
	assert x.root_subelement('TargetConfigurationFile').text == 'TargetConfigurationFile 0x56'
