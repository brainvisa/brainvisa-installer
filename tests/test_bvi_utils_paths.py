...
def test_bvi_utils_Paths():
	...
	assert Paths.BVI_SHARE_LICENSES == ROOTPATH + '/share/brainvisa/installer/licenses'
	assert Paths.BVI_CONFIGURATION 	== ROOTPATH + '/share/brainvisa/installer/xml/configuration.xml'
